...
const VPBackdrop = /* @__PURE__ */ _export_sfc(_sfc_main$1C, [["__scopeId", "data-v-c79a1216"]]);
function deserializeFunctions(r) {
  return Array.isArray(r) ? r.map(deserializeFunctions) : typeof r == "object" && r !== null ? Object.keys(r).reduce((t, n) => (t[n] = deserializeFunctions(r[n]), t), {}) : typeof r == "string" && r.startsWith("_vp-fn_") ? new Function(`return ${r.slice(7)}`)() : r;
}
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"牛牛文档","description":"与热爱不期而遇","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","search":{"provider":"local","options":{"translations":{"button":{"buttonText":"搜索","buttonAriaLabel":"搜索"},"modal":{"displayDetails":"显示详细列表","resetButtonTitle":"重置搜索","backButtonTitle":"关闭搜索","noResultsText":"没有结果","footer":{"selectText":"选择","selectKeyAriaLabel":"输入","navigateText":"导航","navigateUpKeyAriaLabel":"上箭头","navigateDownKeyAriaLabel":"下箭头","closeText":"关闭","closeKeyAriaLabel":"esc"}}}}},"nav":[{"text":"官网","link":"https://www.verysites.com/"},{"text":"AI辅助工作","link":"/vibe-working/"},{"text":"AI辅助编程","link":"/vibe-coding/"},{"text":"全栈开发","link":"/fullstack/"},{"text":"系统重构","link":"/system-refactor/"}],"sidebar":{"/fullstack/":[{"text":"全栈开发指南","collapsed":false,"items":[{"text":"前言","link":"/fullstack/"},{"text":"目录","link":"/fullstack/toc"},{"text":"快速开始","link":"/fullstack/01-getting-started"},{"text":"全栈最佳实践","link":"/fullstack/02-best-practices"},{"text":"测试概览","collapsed":true,"link":"/fullstack/testing/","items":[{"text":"单元测试","link":"/fullstack/testing/02-unit-testing"},{"text":"集成测试","link":"/fullstack/testing/03-integration"},{"text":"端到端测试","link":"/fullstack/testing/04-e2e"}]},{"text":"附录","collapsed":true,"link":"/fullstack/appendix/","items":[{"text":"开发环境搭建","link":"/fullstack/appendix/01-development"},{"text":"部署上线","link":"/fullstack/appendix/02-deployment"},{"text":"开发规范速查","link":"/fullstack/appendix/03-code-standards"}]},{"text":"后端技术栈","collapsed":true,"link":"/fullstack/backend/","items":[{"text":"Node.js 实战","link":"/fullstack/backend/02-nodejs"},{"text":"数据库设计","link":"/fullstack/backend/03-database"},{"text":"API 设计规范","link":"/fullstack/backend/04-api-design"},{"text":"认证与授权","link":"/fullstack/backend/05-authentication"},{"text":"缓存策略","link":"/fullstack/backend/06-caching"}]},{"text":"架构原则","collapsed":true,"link":"/fullstack/architecture/","items":[{"text":"微服务架构","link":"/fullstack/architecture/02-microservices"},{"text":"单体应用","link":"/fullstack/architecture/03-monolith"},{"text":"无服务器架构","link":"/fullstack/architecture/04-serverless"}]},{"text":"企业级实战","collapsed":true,"link":"/fullstack/case-study/","items":[{"text":"扩展功能","collapsed":true,"link":"/fullstack/case-study/extensions/","items":[{"text":"导航系统","link":"/fullstack/case-study/extensions/07-navigation"},{"text":"预约系统","link":"/fullstack/case-study/extensions/08-booking"},{"text":"相册系统","link":"/fullstack/case-study/extensions/09-album"},{"text":"日志监控","link":"/fullstack/case-study/extensions/10-monitoring"}]},{"text":"内容管理系统","collapsed":true,"link":"/fullstack/case-study/content-system/","items":[{"text":"文章系统","link":"/fullstack/case-study/content-system/03-article"},{"text":"分类与标签","link":"/fullstack/case-study/content-system/04-category-tag"},{"text":"富文本编辑","link":"/fullstack/case-study/content-system/05-rich-text"}]},{"text":"文件管理","collapsed":true,"link":"/fullstack/case-study/file-system/","items":[{"text":"文件上传","link":"/fullstack/case-study/file-system/05-upload"},{"text":"权限控制","link":"/fullstack/case-study/file-system/06-permission"}]},{"text":"用户管理系统","collapsed":true,"link":"/fullstack/case-study/user-system/","items":[{"text":"用户表设计","link":"/fullstack/case-study/user-system/02-user-table"},{"text":"角色与权限","link":"/fullstack/case-study/user-system/03-role-permission"},{"text":"认证与授权","link":"/fullstack/case-study/user-system/04-authentication"}]},{"text":"支付系统","collapsed":true,"link":"/fullstack/case-study/payment-system/","items":[{"text":"充值流程","link":"/fullstack/case-study/payment-system/05-recharge"},{"text":"余额系统","link":"/fullstack/case-study/payment-system/06-balance"},{"text":"提现流程","link":"/fullstack/case-study/payment-system/07-withdrawal"}]}]},{"text":"前端技术栈","collapsed":true,"link":"/fullstack/frontend/","items":[{"text":"Vue.js 实战","link":"/fullstack/frontend/02-vue"},{"text":"React 实战","link":"/fullstack/frontend/03-react"},{"text":"TypeScript 最佳实践","link":"/fullstack/frontend/04-typescript"},{"text":"状态管理","link":"/fullstack/frontend/05-state-management"},{"text":"样式方案","link":"/fullstack/frontend/06-styling"},{"text":"性能优化","link":"/fullstack/frontend/07-performance"}]},{"text":"DevOps 概览","collapsed":true,"link":"/fullstack/devops/","items":[{"text":"Docker 容器化","link":"/fullstack/devops/02-docker"},{"text":"CI/CD 流水线","link":"/fullstack/devops/03-ci-cd"},{"text":"监控与日志","link":"/fullstack/devops/04-monitoring"},{"text":"云服务部署","link":"/fullstack/devops/05-cloud"}]}]}],"/system-refactor/":[{"text":"重构你的系统","collapsed":false,"items":[{"text":"前言","link":"/system-refactor/"},{"text":"目录","link":"/system-refactor/toc"},{"text":"重构案例分享","link":"/system-refactor/10-cases"},{"text":"工具思维","collapsed":true,"link":"/system-refactor/tools/","items":[{"text":"自动化工作流","link":"/system-refactor/tools/02-automation"},{"text":"AI 工具整合","link":"/system-refactor/tools/03-ai-tools"},{"text":"效率工具箱","link":"/system-refactor/tools/04-productivity"}]},{"text":"技能迁移理论","collapsed":true,"link":"/system-refactor/skills/","items":[{"text":"刻意练习","link":"/system-refactor/skills/02-deliberate-practice"},{"text":"反馈循环","link":"/system-refactor/skills/03-feedback-loop"},{"text":"费曼学习法","link":"/system-refactor/skills/04-teaching"}]},{"text":"认知升级的重要性","collapsed":true,"link":"/system-refactor/mindset/","items":[{"text":"成长型思维","link":"/system-refactor/mindset/02-growth"},{"text":"高效学习法","link":"/system-refactor/mindset/03-learning"},{"text":"决策框架","link":"/system-refactor/mindset/04-decision-making"}]},{"text":"习惯的力量","collapsed":true,"link":"/system-refactor/habits/","items":[{"text":"晨间惯例","link":"/system-refactor/habits/02-morning-routine"},{"text":"时间管理","link":"/system-refactor/habits/03-time-management"},{"text":"复盘系统","link":"/system-refactor/habits/04-review-system"}]},{"text":"系统化研究方法","collapsed":true,"link":"/system-refactor/research/","items":[{"text":"快速阅读技巧","link":"/system-refactor/research/02-reading"},{"text":"知识管理","link":"/system-refactor/research/03-note-taking"},{"text":"学术写作","link":"/system-refactor/research/04-writing"}]},{"text":"信息检索艺术","collapsed":true,"link":"/system-refactor/search/","items":[{"text":"搜索引擎技巧","link":"/system-refactor/search/02-search-engines"},{"text":"学术资源获取","link":"/system-refactor/search/03-academic"},{"text":"信息验证","link":"/system-refactor/search/04-fact-checking"}]}]}],"/vibe-coding/":[{"text":"AI辅助编程","collapsed":false,"items":[{"text":"前言","link":"/vibe-coding/"},{"text":"目录","link":"/vibe-coding/toc"},{"text":"快速开始","link":"/vibe-coding/01-getting-started"},{"text":"编程思维转变","link":"/vibe-coding/02-mindset"},{"text":"编程工具篇","link":"/vibe-coding/03-tool"},{"text":"典型工作流程","link":"/vibe-coding/04-workflow"},{"text":"提示词工程","link":"/vibe-coding/05-prompt-engineering"},{"text":"最佳实践","link":"/vibe-coding/06-best-practices"},{"text":"调试技巧","link":"/vibe-coding/07-debugging"},{"text":"AI 代码审查","link":"/vibe-coding/08-code-review"},{"text":"AI 辅助测试","link":"/vibe-coding/09-testing"},{"text":"AI 辅助重构","link":"/vibe-coding/10-refactoring"},{"text":"安全注意事项","link":"/vibe-coding/11-security"},{"text":"实战案例","link":"/vibe-coding/12-cases"}]}],"/vibe-working/":[{"text":"AI 辅助工作","collapsed":false,"items":[{"text":"前言","link":"/vibe-working/"},{"text":"目录","link":"/vibe-working/toc"},{"text":"常用 AI 工具介绍","link":"/vibe-working/01-tools"},{"text":"AI 辅助写作","link":"/vibe-working/02-writing"},{"text":"AI 辅助研究","link":"/vibe-working/03-research"},{"text":"AI 辅助数据分析","link":"/vibe-working/04-data-analysis"},{"text":"AI 辅助会议","link":"/vibe-working/05-meeting"},{"text":"AI 辅助演示文稿","link":"/vibe-working/06-presentation"},{"text":"AI 辅助翻译","link":"/vibe-working/07-translation"},{"text":"AI 辅助创意工作","link":"/vibe-working/08-creative"},{"text":"效率提升技巧","link":"/vibe-working/09-productivity"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/bulls-cows/docs"}],"footer":{"message":"天上的神明与星辰，人间的艺术和真纯，我们所敬畏和热爱的，莫过于此。","copyright":"Copyright © 2009-2026 Yakima Teng. All rights reserved."},"docFooter":{"prev":"上一篇","next":"下一篇"},"darkModeSwitchLabel":"外观","darkModeSwitchTitle":"切换到暗黑模式","lightModeSwitchTitle":"切换到亮色模式","returnToTopLabel":"返回顶部","sidebarMenuLabel":"菜单","lastUpdated":{"text":"最近更新时间"},"outline":{"label":"目录","level":[2,3]},"externalLinkIcon":true},"locales":{},"scrollOffset":134,"cleanUrls":false,"additionalConfig":{}}'));
...
const NotFound$1 = /* @__PURE__ */ _export_sfc(_sfc_main$1B, [["__scopeId", "data-v-829df670"]]);
...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$1A, [["__scopeId", "data-v-1ce71065"]]);
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$1z, [["__scopeId", "data-v-60d5052e"]]);
...
const VPDocAside = /* @__PURE__ */ _export_sfc(_sfc_main$1x, [["__scopeId", "data-v-3f215769"]]);
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$1v, [["__scopeId", "data-v-3c637f39"]]);
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$1u, [["__scopeId", "data-v-e257564d"]]);
...
const VPDoc = /* @__PURE__ */ _export_sfc(_sfc_main$1t, [["__scopeId", "data-v-7011f0d8"]]);
...
const VPButton = /* @__PURE__ */ _export_sfc(_sfc_main$1s, [["__scopeId", "data-v-01bff58b"]]);
...
const VPImage = /* @__PURE__ */ _export_sfc(_sfc_main$1r, [["__scopeId", "data-v-8426fc1a"]]);
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$1q, [["__scopeId", "data-v-e62e4946"]]);
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$1o, [["__scopeId", "data-v-e5511d04"]]);
...
const VPFeatures = /* @__PURE__ */ _export_sfc(_sfc_main$1n, [["__scopeId", "data-v-a6181336"]]);
...
const VPHomeContent = /* @__PURE__ */ _export_sfc(_sfc_main$1l, [["__scopeId", "data-v-8e2d4988"]]);
const _sfc_main$1k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1p, null, {
        "home-hero-info-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "home-hero-info-before", {}, null, _push2, _parent2, _scopeId);
          } else {
...
const VPHome = /* @__PURE__ */ _export_sfc(_sfc_main$1k, [["__scopeId", "data-v-bb6342a6"]]);
const _sfc_main$1j = {};
...
const VPPage = /* @__PURE__ */ _export_sfc(_sfc_main$1j, [["ssrRender", _sfc_ssrRender$u]]);
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$1i, [["__scopeId", "data-v-9dc86fcc"]]);
...
const VPFooter = /* @__PURE__ */ _export_sfc(_sfc_main$1h, [["__scopeId", "data-v-c3855bb3"]]);
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$1g, [["__scopeId", "data-v-0bf0e06f"]]);
...
const VPLocalNav = /* @__PURE__ */ _export_sfc(_sfc_main$1f, [["__scopeId", "data-v-db738f89"]]);
function useNav() {
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$1e, [["ssrRender", _sfc_ssrRender$t], ["__scopeId", "data-v-1d5665e3"]]);
const _sfc_main$1d = /* @__PURE__ */ defineComponent({
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$1d, [["__scopeId", "data-v-5337faa4"]]);
const _sfc_main$1c = /* @__PURE__ */ defineComponent({
...
const VPNavBarAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$1c, [["__scopeId", "data-v-6c893767"]]);
...
const _sfc_main$1b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1w, mergeProps(_ctx.$attrs, {
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$1b, [["__scopeId", "data-v-867c295f"]]);
const _sfc_main$1a = /* @__PURE__ */ defineComponent({
  __name: "VPMenuGroup",
  __ssrInlineRender: true,
  props: {
...
const VPMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$1a, [["__scopeId", "data-v-1963e1bb"]]);
...
const VPMenu = /* @__PURE__ */ _export_sfc(_sfc_main$19, [["__scopeId", "data-v-25a6cce8"]]);
...
const VPFlyout = /* @__PURE__ */ _export_sfc(_sfc_main$18, [["__scopeId", "data-v-42cb505d"]]);
...
const VPSocialLink = /* @__PURE__ */ _export_sfc(_sfc_main$17, [["__scopeId", "data-v-591a6b30"]]);
...
const VPSocialLinks = /* @__PURE__ */ _export_sfc(_sfc_main$16, [["__scopeId", "data-v-d07f11e6"]]);
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc(_sfc_main$15, [["__scopeId", "data-v-562c832a"]]);
...
const VPNavBarHamburger = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["__scopeId", "data-v-e5dd9c1c"]]);
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["__scopeId", "data-v-6dd25bb8"]]);
...
const VPNavBarMenu = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["__scopeId", "data-v-39714824"]]);
...
const VPNavBarAskAiButton = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["ssrRender", _sfc_ssrRender$s], ["__scopeId", "data-v-4eb17e89"]]);
...
const VPNavBarSearchButton = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["__scopeId", "data-v-baa3be99"]]);
const _sfc_main$_ = /* @__PURE__ */ defineComponent({
  __name: "VPNavBarSearch",
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DOYtXw0Z.js"));
...
const VPNavBarSearch = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["__scopeId", "data-v-2fc7f2c6"]]);
...
const VPNavBarSocialLinks = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["__scopeId", "data-v-0394ad82"]]);
...
const VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["__scopeId", "data-v-1e38c6bc"]]);
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["__scopeId", "data-v-fafa8c23"]]);
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["__scopeId", "data-v-9ca1369d"]]);
...
const VPNavScreenAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["__scopeId", "data-v-b44890b2"]]);
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["__scopeId", "data-v-b924ab8a"]]);
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["__scopeId", "data-v-ecf4b472"]]);
...
const VPNavScreenMenuGroupSection = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["__scopeId", "data-v-4b7a798b"]]);
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["__scopeId", "data-v-956364f9"]]);
...
const VPNavScreenTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["__scopeId", "data-v-a4d9b172"]]);
...
const VPNavScreen = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["__scopeId", "data-v-05f3d7bc"]]);
...
const VPNav = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["__scopeId", "data-v-9f75dce3"]]);
          ...
          if (_push2) {
            ...
            return [
              __props.item.text ? (openBlock(), createBlock("div", mergeProps({
                ...
                __props.item.link ? (openBlock(), createBlock(_sfc_main$1w, {
                  key: 0,
                  tag: linkTag.value,
                  class: "link",
                  href: __props.item.link,
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["__scopeId", "data-v-d81de50c"]]);
...
const VPSidebarGroup = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["__scopeId", "data-v-8d50c081"]]);
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["__scopeId", "data-v-af661f50"]]);
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["__scopeId", "data-v-331ec75c"]]);
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["__scopeId", "data-v-0cf61682"]]);
const GridSettings = {
  xmini: [[0, 2]],
  mini: [],
  small: [
...
const VPTeamMembersItem = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-962fd8c0"]]);
...
const _sfc_main$x = /* @__PURE__ */ defineComponent({
  __name: "HomeHeroImage",
  __ssrInlineRender: true,
  setup(__props) {
    const { page } = useData$1();
    const heroImageSrc = computed(() => {
      return page.value.frontmatter.hero?.image?.src || "";
    });
    const heroImageAlt = computed(() => {
      return page.value.frontmatter.hero?.image?.alt || "";
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-hero-image" }, _attrs))} data-v-624192b6><img class="img"${ssrRenderAttr("src", heroImageSrc.value)}${ssrRenderAttr("alt", heroImageAlt.value)} data-v-624192b6></div>`);
    };
  }
});
const _sfc_setup$x = _sfc_main$x.setup;
_sfc_main$x.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeHeroImage.vue");
  return _sfc_setup$x ? _sfc_setup$x(props, ctx) : void 0;
};
const HomeHeroImage = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-624192b6"]]);
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  __name: "HomeHeroInfo",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const title = computed(() => {
      return page.value.frontmatter.hero?.name || "";
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-hero-info" }, _attrs))} data-v-510e8c31><h1 class="title" data-v-510e8c31>${ssrInterpolate(title.value)}</h1></div>`);
    };
  }
});
const _sfc_setup$w = _sfc_main$w.setup;
_sfc_main$w.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeHeroInfo.vue");
  return _sfc_setup$w ? _sfc_setup$w(props, ctx) : void 0;
};
const HomeHeroInfo = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["__scopeId", "data-v-510e8c31"]]);
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  __name: "HomeHeroInfoAfter",
  __ssrInlineRender: true,
  setup(__props) {
    const { page } = useData$1();
    const taglines = computed(() => {
      return (page.value.frontmatter.hero?.tagline || "").split("\n");
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-hero-info-after" }, _attrs))} data-v-dbe8979d><!--[-->`);
      ssrRenderList(taglines.value, (tagline, idx) => {
        _push(`<div class="tag-line" data-v-dbe8979d>${ssrInterpolate(tagline)}</div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main$v.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeHeroInfoAfter.vue");
  return _sfc_setup$v ? _sfc_setup$v(props, ctx) : void 0;
};
const HomeHeroInfoAfter = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["__scopeId", "data-v-dbe8979d"]]);
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  __name: "HomeHeroInfoBefore",
  __ssrInlineRender: true,
  setup(__props) {
    const { page } = useData$1();
    const text = computed(() => {
      return page.value.frontmatter.hero?.text || "";
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-hero-info-before" }, _attrs))} data-v-a1528332><h2 class="title" data-v-a1528332>${ssrInterpolate(text.value)}</h2></div>`);
    };
  }
});
const _sfc_setup$u = _sfc_main$u.setup;
_sfc_main$u.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeHeroInfoBefore.vue");
  return _sfc_setup$u ? _sfc_setup$u(props, ctx) : void 0;
};
const HomeHeroInfoBefore = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["__scopeId", "data-v-a1528332"]]);
const _sfc_main$t = {};
function _sfc_ssrRender$r(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-hero-before" }, _attrs))} data-v-dac85527></div>`);
}
const _sfc_setup$t = _sfc_main$t.setup;
_sfc_main$t.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeHeroBefore.vue");
  return _sfc_setup$t ? _sfc_setup$t(props, ctx) : void 0;
};
const HomeHeroBefore = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["ssrRender", _sfc_ssrRender$r], ["__scopeId", "data-v-dac85527"]]);
const _sfc_main$s = {};
function _sfc_ssrRender$q(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-hero-actions-after" }, _attrs))}></div>`);
}
const _sfc_setup$s = _sfc_main$s.setup;
_sfc_main$s.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeHeroActionsAfter.vue");
  return _sfc_setup$s ? _sfc_setup$s(props, ctx) : void 0;
};
const HomeHeroActionsAfter = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["ssrRender", _sfc_ssrRender$q]]);
const _sfc_main$r = {};
function _sfc_ssrRender$p(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-hero-after" }, _attrs))}></div>`);
}
const _sfc_setup$r = _sfc_main$r.setup;
_sfc_main$r.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeHeroAfter.vue");
  return _sfc_setup$r ? _sfc_setup$r(props, ctx) : void 0;
};
const HomeHeroAfter = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["ssrRender", _sfc_ssrRender$p]]);
const _sfc_main$q = {};
function _sfc_ssrRender$o(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-features-before" }, _attrs))} data-v-24f65f44><div class="section-main-title" data-v-24f65f44>文档</div><div class="section-sub-title" data-v-24f65f44>DOCUMENTS</div></div>`);
}
const _sfc_setup$q = _sfc_main$q.setup;
_sfc_main$q.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeFeaturesBefore.vue");
  return _sfc_setup$q ? _sfc_setup$q(props, ctx) : void 0;
};
const HomeFeaturesBefore = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["ssrRender", _sfc_ssrRender$o], ["__scopeId", "data-v-24f65f44"]]);
const _sfc_main$p = {};
...
_sfc_main$p.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Home/HomeFeaturesAfter.vue");
  return _sfc_setup$p ? _sfc_setup$p(props, ctx) : void 0;
};
const HomeFeaturesAfter = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["ssrRender", _sfc_ssrRender$n], ["__scopeId", "data-v-b3b8b617"]]);
const _sfc_main$o = {};
function _sfc_ssrRender$m(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "component-user-profile" }, _attrs))} data-v-03412b57></div>`);
}
const _sfc_setup$o = _sfc_main$o.setup;
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/AsideTop.vue");
  return _sfc_setup$o ? _sfc_setup$o(props, ctx) : void 0;
};
const AsideTop = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["ssrRender", _sfc_ssrRender$m], ["__scopeId", "data-v-03412b57"]]);
const _sfc_main$n = {};
function _sfc_ssrRender$l(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "aside-bottom" }, _attrs))}></div>`);
}
const _sfc_setup$n = _sfc_main$n.setup;
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/AsideBottom.vue");
  return _sfc_setup$n ? _sfc_setup$n(props, ctx) : void 0;
};
const AsideBottom = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["ssrRender", _sfc_ssrRender$l]]);
const _sfc_main$m = {};
function _sfc_ssrRender$k(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "aside-ads-before" }, _attrs))}></div>`);
}
const _sfc_setup$m = _sfc_main$m.setup;
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/AsideAdsBefore.vue");
  return _sfc_setup$m ? _sfc_setup$m(props, ctx) : void 0;
};
const AsideAdsBefore = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["ssrRender", _sfc_ssrRender$k]]);
const _sfc_main$l = {};
function _sfc_ssrRender$j(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "aside-ads-after" }, _attrs))}></div>`);
}
const _sfc_setup$l = _sfc_main$l.setup;
_sfc_main$l.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/AsideAdsAfter.vue");
  return _sfc_setup$l ? _sfc_setup$l(props, ctx) : void 0;
};
const AsideAdsAfter = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$j]]);
const _sfc_main$k = {};
function _sfc_ssrRender$i(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "aside-outline-before" }, _attrs))}></div>`);
}
const _sfc_setup$k = _sfc_main$k.setup;
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/AsideOutlineBefore.vue");
  return _sfc_setup$k ? _sfc_setup$k(props, ctx) : void 0;
};
const AsideOutlineBefore = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["ssrRender", _sfc_ssrRender$i]]);
const _sfc_main$j = {};
function _sfc_ssrRender$h(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "aside-outline-after" }, _attrs))}></div>`);
}
const _sfc_setup$j = _sfc_main$j.setup;
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/AsideOutlineAfter.vue");
  return _sfc_setup$j ? _sfc_setup$j(props, ctx) : void 0;
};
const AsideOutlineAfter = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$h]]);
const _sfc_main$i = {};
function _sfc_ssrRender$g(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "doc-top" }, _attrs))}></div>`);
}
const _sfc_setup$i = _sfc_main$i.setup;
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/DocTop.vue");
  return _sfc_setup$i ? _sfc_setup$i(props, ctx) : void 0;
};
const DocTop = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["ssrRender", _sfc_ssrRender$g]]);
const _sfc_main$h = {};
function _sfc_ssrRender$f(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "doc-bottom" }, _attrs))}></div>`);
}
const _sfc_setup$h = _sfc_main$h.setup;
_sfc_main$h.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/DocBottom.vue");
  return _sfc_setup$h ? _sfc_setup$h(props, ctx) : void 0;
};
const DocBottom = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$f]]);
const _sfc_main$g = {};
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "doc-footer-before" }, _attrs))}></div>`);
}
const _sfc_setup$g = _sfc_main$g.setup;
_sfc_main$g.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/DocFooterBefore.vue");
  return _sfc_setup$g ? _sfc_setup$g(props, ctx) : void 0;
};
const DocFooterBefore = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$e]]);
const _sfc_main$f = {};
function _sfc_ssrRender$d(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "doc-before" }, _attrs))} data-v-4c600229></div>`);
}
const _sfc_setup$f = _sfc_main$f.setup;
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/DocBefore.vue");
  return _sfc_setup$f ? _sfc_setup$f(props, ctx) : void 0;
};
const DocBefore = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$d], ["__scopeId", "data-v-4c600229"]]);
const _sfc_main$e = {};
function _sfc_ssrRender$c(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "doc-after" }, _attrs))}></div>`);
}
const _sfc_setup$e = _sfc_main$e.setup;
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/DocAfter.vue");
  return _sfc_setup$e ? _sfc_setup$e(props, ctx) : void 0;
};
const DocAfter = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$c]]);
const _sfc_main$d = {};
function _sfc_ssrRender$b(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "sidebar-nav-before" }, _attrs))}></div>`);
}
const _sfc_setup$d = _sfc_main$d.setup;
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/SidebarNavBefore.vue");
  return _sfc_setup$d ? _sfc_setup$d(props, ctx) : void 0;
};
const SidebarNavBefore = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$b]]);
const _sfc_main$c = {};
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "sidebar-nav-after" }, _attrs))}></div>`);
}
const _sfc_setup$c = _sfc_main$c.setup;
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Doc/SidebarNavAfter.vue");
  return _sfc_setup$c ? _sfc_setup$c(props, ctx) : void 0;
};
const SidebarNavAfter = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$a]]);
const _sfc_main$b = {};
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-top" }, _attrs))}></div>`);
}
const _sfc_setup$b = _sfc_main$b.setup;
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Page/PageTop.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const PageTop = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$9]]);
const _sfc_main$a = {};
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-bottom" }, _attrs))}></div>`);
}
const _sfc_setup$a = _sfc_main$a.setup;
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Page/PageBottom.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const PageBottom = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$9 = {};
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/NotFound.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$8 = {};
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout-top" }, _attrs))}></div>`);
}
const _sfc_setup$8 = _sfc_main$8.setup;
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/LayoutTop.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const LayoutTop = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (isHome.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout-bottom" }, _attrs))} data-v-4a19b053><!--[-->`);
        ssrRenderList(linkList, (item, idx) => {
          _push(`<a class="link"${ssrRenderAttr("href", item.url)}${ssrRenderAttr("title", item.tip)} target="_blank" rel="noreferrer noopener" data-v-4a19b053>${ssrInterpolate(item.label)}</a>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/LayoutBottom.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const LayoutBottom = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-4a19b053"]]);
const _sfc_main$6 = {};
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "nav-bar-title-before" }, _attrs))}></div>`);
}
const _sfc_setup$6 = _sfc_main$6.setup;
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/NavBarTitleBefore.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const NavBarTitleBefore = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$5]]);
const _sfc_main$5 = {};
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "nav-bar-title-after" }, _attrs))}></div>`);
}
const _sfc_setup$5 = _sfc_main$5.setup;
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/NavBarTitleAfter.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const NavBarTitleAfter = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$4]]);
const _sfc_main$4 = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "nav-bar-content-before" }, _attrs))}></div>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/NavBarContentBefore.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const NavBarContentBefore = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$3 = {};
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "nav-bar-content-after" }, _attrs))}></div>`);
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/NavBarContentAfter.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const NavBarContentAfter = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$2 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "nav-screen-content-before" }, _attrs))}></div>`);
}
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/NavScreenContentBefore.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const NavScreenContentBefore = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "nav-screen-content-after" }, _attrs))}></div>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/components/Global/NavScreenContentAfter.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const NavScreenContentAfter = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main = {
  __name: "MyLayout",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Layout2), _attrs, {
        "layout-top": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(LayoutTop, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(LayoutTop)
            ];
          }
        }),
        "layout-bottom": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(LayoutBottom, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(LayoutBottom)
            ];
          }
        }),
        "nav-bar-title-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(NavBarTitleBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(NavBarTitleBefore)
            ];
          }
        }),
        "nav-bar-title-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(NavBarTitleAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(NavBarTitleAfter)
            ];
          }
        }),
        "nav-bar-content-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(NavBarContentBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(NavBarContentBefore)
            ];
          }
        }),
        "nav-bar-content-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(NavBarContentAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(NavBarContentAfter)
            ];
          }
        }),
        "nav-screen-content-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(NavScreenContentBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(NavScreenContentBefore)
            ];
          }
        }),
        "nav-screen-content-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(NavScreenContentAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(NavScreenContentAfter)
            ];
          }
        }),
        "not-found": withCtx((_, _push2, _parent2, _scopeId) => {
        ...
        "page-top": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(PageTop, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(PageTop)
            ];
        ...
        "page-bottom": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(PageBottom, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(PageBottom)
            ];
          }
        }),
        "home-hero-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeHeroBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeHeroBefore)
            ];
          }
        }),
        "home-hero-info-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeHeroInfoBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeHeroInfoBefore)
            ];
          }
        }),
        "home-hero-info": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeHeroInfo, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeHeroInfo)
            ];
          }
        }),
        "home-hero-info-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeHeroInfoAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeHeroInfoAfter)
            ];
          }
        }),
        "home-hero-actions-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeHeroActionsAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeHeroActionsAfter)
            ];
          }
        }),
        "home-hero-image": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeHeroImage, null, null, _parent2, _scopeId));
          } else {
            return [
        ...
        "home-hero-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeHeroAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeHeroAfter)
            ];
          }
        }),
        "home-features-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeFeaturesBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeFeaturesBefore)
            ];
          }
        }),
        "home-features-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(HomeFeaturesAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(HomeFeaturesAfter)
            ];
          }
        }),
        "doc-top": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(DocTop, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(DocTop)
            ];
        ...
        "doc-bottom": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(DocBottom, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(DocBottom)
            ];
          }
        }),
        "doc-footer-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(DocFooterBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(DocFooterBefore)
            ];
          }
        }),
        "doc-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(DocBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(DocBefore)
            ];
          }
        }),
        "doc-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(DocAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(DocAfter)
            ];
          }
        }),
        "sidebar-nav-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(SidebarNavBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(SidebarNavBefore)
            ];
          }
        }),
        "sidebar-nav-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(SidebarNavAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(SidebarNavAfter)
            ];
          }
        }),
        "aside-top": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AsideTop, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AsideTop)
            ];
          }
        }),
        "aside-bottom": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AsideBottom, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AsideBottom)
            ];
          }
        }),
        "aside-outline-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AsideOutlineBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AsideOutlineBefore)
            ];
          }
        }),
        "aside-outline-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AsideOutlineAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AsideOutlineAfter)
            ];
          }
        }),
        "aside-ads-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AsideAdsBefore, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AsideAdsBefore)
            ];
          }
        }),
        "aside-ads-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AsideAdsAfter, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AsideAdsAfter)
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../config/.vitepress/theme/MyLayout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RawTheme = {
  extends: theme,
  Layout: () => {
    return h(_sfc_main, null, {
