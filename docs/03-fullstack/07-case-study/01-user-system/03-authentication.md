...
- [认证与授权](../../03-backend/04-authentication.md) - 认证授权原理
- [API设计规范](../../03-backend/03-api-design.md) - 接口设计规范
...
- [用户表设计](./01-user-table.md) - 用户表结构设计
- [角色与权限](./02-role-permission.md) - 角色权限控制
