...
把错误信息粘贴给 AI，让它修复。具体方法见 [调试技巧](./07-debugging.md)。

### AI 不理解我的需求怎么办？

换个说法，或者拆分成更小的步骤。提示词优化技巧见 [提示词工程](./05-prompt-engineering.md)。

### AI 生成的代码质量可靠吗？

AI 生成的代码需要审查，尤其是安全性和错误处理方面。详见 [最佳实践](./06-best-practices.md) 和 [安全注意事项](./11-security.md)。

### 想要更系统地学习？

- [编程思维转变](./02-mindset.md) —— 理解 AI 编程的思维方式
- [典型工作流程](./04-workflow.md) —— 建立规范的开发流程
- [实战案例](./12-cases.md) —— 更多完整项目案例
